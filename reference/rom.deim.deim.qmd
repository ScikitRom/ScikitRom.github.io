...
| [sopt_red](#skrom.rom.deim.deim.deim.sopt_red) | S-OPT sampling: selects rows maximising the S-optimality measure |
...
| Name                     | Type                      | Description                                           | Default    |
|--------------------------|---------------------------|-------------------------------------------------------|------------|
| f_basis                  | ndarray(N, n_modes_total) | Full empirical basis from SVD of nonlinear snapshots. | _required_ |
| num_f_basis_vectors_used | int                       | Number of basis vectors (modes) to use.               | _required_ |

###### Returns {.doc-section .doc-section-returns}

| Name          | Type            | Description                              |
|---------------|-----------------|------------------------------------------|
| f_sampled_row | ndarray         | Rows of f_basis at the selected indices. |
| Z_indices     | list of int     | Selected row indices.                    |
| Z_boolean     | ndarray of bool | Boolean mask of selected rows.           |
