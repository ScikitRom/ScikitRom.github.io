# utils.data_io.save_h5 { #skrom.utils.data_io.save_h5 }
...
| Name | Description |
| --- | --- |
| [H5ArrayListSpec](#skrom.utils.data_io.save_h5.H5ArrayListSpec) | Naming spec for datasets in the group. |

### H5ArrayListSpec { #skrom.utils.data_io.save_h5.H5ArrayListSpec }
...
| Name | Description |
| --- | --- |
| [iter_array_list_h5](#skrom.utils.data_io.save_h5.iter_array_list_h5) | Iterate arrays one-by-one (reduces peak RAM versus loading all at once). |
| [list_keys_h5](#skrom.utils.data_io.save_h5.list_keys_h5) | Return dataset keys under the target group. |
| [load_array_h5](#skrom.utils.data_io.save_h5.load_array_h5) | Load a single array by index. |
| [load_array_list_h5](#skrom.utils.data_io.save_h5.load_array_list_h5) | Load the full list into memory. |
| [load_metadata_h5](#skrom.utils.data_io.save_h5.load_metadata_h5) | Load optional metadata dict stored at save time; returns {} if absent. |
| [save_array_list_h5](#skrom.utils.data_io.save_h5.save_array_list_h5) | Save a list of arrays (variable shapes allowed) into a single HDF5 file. |

### iter_array_list_h5 { #skrom.utils.data_io.save_h5.iter_array_list_h5 }
...
### list_keys_h5 { #skrom.utils.data_io.save_h5.list_keys_h5 }
...
### load_array_h5 { #skrom.utils.data_io.save_h5.load_array_h5 }
...
### load_array_list_h5 { #skrom.utils.data_io.save_h5.load_array_list_h5 }
...
### load_metadata_h5 { #skrom.utils.data_io.save_h5.load_metadata_h5 }
...
### save_array_list_h5 { #skrom.utils.data_io.save_h5.save_array_list_h5 }
