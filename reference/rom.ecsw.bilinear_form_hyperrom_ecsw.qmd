...
| weight           | ndarray         | Array of ECSW weights                                                                                                             |
| nonzero_elements | ndarray         | Indices of elements with non-zero weights                                                                                         |
| ubasis_rom       | Basis           | Trial basis restricted to non-zero weight elements                                                                                |
| vbasis_rom       | Basis           | Test basis restricted to non-zero weight elements                                                                                 |
| element_dofs     | ndarray         | Element-to-DOF connectivity for restricted mesh                                                                                   |
| free_indices     | ndarray         | Free DOF indices for each element                                                                                                 |
| mask             | ndarray of bool | Boolean mask indicating which DOFs are free in each element                                                                       |
...
| Name | Description |
| --- | --- |
| [with_elements](#skrom.rom.ecsw.bilinear_form_hyperrom_ecsw.with_elements) | Return a similar basis on a subset of element indices. |
...
| Name     | Type            | Description                                        | Default   |
|----------|-----------------|----------------------------------------------------|-----------|
| elements | Optional\[Any\] | Subset of element indices to restrict the basis to | `None`    |

#### Returns {.doc-section .doc-section-returns}

| Name   | Type       | Description                                              |
|--------|------------|----------------------------------------------------------|
|        | FacetBasis | New FacetBasis instance restricted to specified elements |