...
| Name | Description |
| --- | --- |
| [LinearFormHYPERROM](#skrom.rom.linear_form_hyperrom.LinearFormHYPERROM) | Reduced-order linear form for hyper-reduction of load vectors. |

### LinearFormHYPERROM { #skrom.rom.linear_form_hyperrom.LinearFormHYPERROM }
...
| Name | Description |
| --- | --- |
| [assemble_weighted](#skrom.rom.linear_form_hyperrom.LinearFormHYPERROM.assemble_weighted) | Assemble the weighted reduced load vector. |
| [extract_element_vector](#skrom.rom.linear_form_hyperrom.LinearFormHYPERROM.extract_element_vector) | Extract local element load vectors for full-order linear forms. |
| [extract_element_vector_rom](#skrom.rom.linear_form_hyperrom.LinearFormHYPERROM.extract_element_vector_rom) | Extract local element load vectors in the reduced setting. |

##### assemble_weighted { #skrom.rom.linear_form_hyperrom.LinearFormHYPERROM.assemble_weighted }
...
##### extract_element_vector { #skrom.rom.linear_form_hyperrom.LinearFormHYPERROM.extract_element_vector }
...
##### extract_element_vector_rom { #skrom.rom.linear_form_hyperrom.LinearFormHYPERROM.extract_element_vector_rom }
