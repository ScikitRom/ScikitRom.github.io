# rom.ecsw.linear_form_hyperrom_ecsw { #skrom.rom.ecsw.linear_form_hyperrom_ecsw }
...
| Name | Description |
| --- | --- |
| [LinearFormHYPERROM_ecsw](#skrom.rom.ecsw.linear_form_hyperrom_ecsw.LinearFormHYPERROM_ecsw) | Reduced-order linear form for hyper-reduction of load vectors. |
...
| Name | Description |
| --- | --- |
| [assemble_weighted_ecsw](#skrom.rom.ecsw.linear_form_hyperrom_ecsw.LinearFormHYPERROM_ecsw.assemble_weighted_ecsw) | Assemble the weighted reduced load vector. |
| [extract_element_vector_rom](#skrom.rom.ecsw.linear_form_hyperrom_ecsw.LinearFormHYPERROM_ecsw.extract_element_vector_rom) | Extract local element load vectors in the reduced setting. |
...
| Name | Description |
| --- | --- |
| [with_elements](#skrom.rom.ecsw.linear_form_hyperrom_ecsw.with_elements) | Return a similar basis on a subset of element indices. |
