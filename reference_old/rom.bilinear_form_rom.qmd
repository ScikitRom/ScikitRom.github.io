...
| [extract_element_matrices](#skrom.rom.bilinear_form_rom.BilinearFormROM.extract_element_matrices) | Extract local element stiffness matrices for a given bilinear form. |
